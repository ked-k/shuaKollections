...
WHERE `sale`.`State` = 'Pending'
GROUP BY `sale`.`Q-code`
 ";
 ...
 ?>
                  <tr>
                    ...
                    <td>  <?php echo $row['Uname'] ;?>     </td>
                     ...
                     <td>  <?php echo $row['Q-code'] ;?>     </td>
                     <td>  <?php echo $row['amt'] ;?>     </td>
                     <td>  <?php echo $row['SDate'] ;?>     </td>
                    <td> <a class="" href="viewsale?scode=<?php echo $row['Q-code'] ;?>"><i class="fa fa-eye"></i></a>
                    <a class="" href="newsale?scode=<?php echo $row['Q-code'] ;?>"><i class="fa fa-edit"></i></a>
                      <a class="" href="#draftsales?id=<?php echo $row['Sid'] ;?>"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
        <?php }} ?>
                  </tbody>
