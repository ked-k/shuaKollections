...
for($i=0; $row = $result->fetch_assoc(); $i++) {
 ...
 ?>
                  <tr>
                    ...
                    <td> 
                    <a class="" href="editsale?scode=<?php echo $row['Sid'] ;?>"><i class="fa fa-edit"></i></a>
        ...
        <?php }} ?>
                ...
                <button type="submit" onclick="return confirm('Are you sure you want to save, no more changes will be made after!');" class="btn btn-info">Save sale</button>
                </form>
              </div>
              <!-- end of col-6 -->
