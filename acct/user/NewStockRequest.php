          ...
          <div class="section-body">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-info text-white-all">
                        ...
                        <li class="breadcrumb-item"><a href="#"><i class="far fa-file"></i>New request</a></li>
            ...
            <div class="row">
                  ...
                  <div class="card-body">
                      ...
                      <form method="POST" action="addStockRequest" >
...
for($i=0; $row = $result->fetch_assoc(); $i++) {
 ...
 ?>
  <option value="<?php echo $row['Pid'] ;?>"><?php echo $row['PName'].' '. $row['UOM'].' Qty-left '. $row['QtyLeft']  ;}}?></option>
