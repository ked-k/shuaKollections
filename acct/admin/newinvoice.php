...
$resultd = mysqli_query($conn,"UPDATE products SET DmdQrty=DmdQrty-'$pcs' WHERE products.Pid = '$DPdtid' "); 
...
$result = mysqli_query($conn,"UPDATE products SET DmdQrty=DmdQrty-'$valid' WHERE products.Pid = '$Pdtid' ");  
...
<head>
  ...
  <title><?php echo $appname ?> | New invoice</title>
  <!-- General CSS Files -->
          ...
          <div class="section-body">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-primary text-white-all">
                        ...
                        <li class="breadcrumb-item"><a href="#"><i class="far fa-file"></i>New invoice</a></li>
...
<?php }} ?>
           ...
           <input type="number" class="form-control" name="soldamt" value="0"  id="soldamt" onchange="sfill()" required>
                 ...
                 <div class="col-md-6">
                    ...
                    <input type="submit"  name="save_sale" value="Add sale"  class="btn btn-success"/>
                  </form>
                  </div>
                </div>
               ...
               <div class="row">
                <div class="col-md-4" style="padding: 10px;">
                 <div class="input-group">                        
                        ...
                        <input type="text" class="form-control" id="paid" onchange="pfill()" value="0" name="paid" >
                      </div>
                      </div>
                   ...
                   <input type="text" readonly="" class="form-control" id="bal" value="0" name="balance" >
                      ...
                      <div class="input-group">                        
                          ...
                          <select  class="form-control select2" name="customer" id="customer" onchange="pfill()" required >
...
<?php }} ?>
                ...
                <input type="submit" disabled="" <?php echo $btn ?> onclick="return confirm('Are you sure you want to save, no more changes will be made after!');" class="btn btn-info" name="save" value="Save sale">
                <input type="submit" disabled="" <?php echo $btn ?> onclick="return confirm('Are you sure you want to save, no more changes will be made after!');" class="btn btn-success" name="sprnt" value="Save Print">
                </form>
              </div>
              <!-- end of col-6 -->
