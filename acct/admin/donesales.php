...
<head>
  ...
  <title><?php echo $appname ?> | done sale</title>
  <!-- General CSS Files -->
          ...
          <div class="section-body">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-primary text-white-all">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Approved sales</li>
                      </ol>
                    </nav>
               <div class="row">
...
WHERE `sale`.`State` = 'Saved' AND SaleLocation = '$curBranchId'
...
for($i=0; $row = $result->fetch_assoc(); $i++) {
 ...
 ?>
                  <tr>
                    ...
                    <td> <a class="" href="invoice?scode=<?php echo $row['Scode'] ;?>"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
        <?php }} ?>
                  </tbody>
