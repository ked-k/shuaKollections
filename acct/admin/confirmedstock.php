...
<head>
  ...
  <title><?php echo $appname ?> | Confirmed stock</title>
  <!-- General CSS Files -->
          ...
          <div class="section-body">
                <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-primary text-white-all">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">confirmed stock</li>
                      </ol>
                    </nav>
               <div class="row">
...
WHERE `stock`.`State` = 'Saved' AND 	SBlocation = '$curBranchId' 
