...
$id=$_GET['supid'];
try{
$result = $db->prepare("DELETE FROM supplier WHERE Supid= $id");
  $result->execute();  
...
<?php include 'addSup.php';?>

<!-- ked did it-->
<head>
  <meta charset="UTF-8">
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
  <title><?php echo $appname ?> | suppliers</title>
  <!-- General CSS Files -->
          ...
          <div class="section-body">
             <nav aria-label="breadcrumb">
                      <ol class="breadcrumb bg-primary text-white-all">
                        ...
                        <li class="breadcrumb-item"><a href="#"><i class="fas fa-user-friends"></i>Suppliers</a></li>
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-header">
                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-info">Add supplier</button>
                  </div>
                  <div class="card-body">
...
$result = $db->prepare(" SELECT * FROM `supplier` ");
 ...
 ?>
                  <tr>
                    ...
                    <td> 
                      <a onclick="return confirm('Are you sure you want to delete?');" href="suppliers?supid=<?php echo $row['Supid'] ;?>"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
        <?php } ?>
                  </tbody>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="formModal">New supplier</h5>
              ...
              <div class="modal-body">
                <form class="" method="POST" action="">
                  ...
                  <button type="submit" name="saveSup" class="btn btn-primary m-t-15 float-right waves-effect">Save</button>
                </form>
              </div>
            </div>
          </div>
